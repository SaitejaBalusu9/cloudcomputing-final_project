...
def insertCSVData():
    ...
    if '400_products' in fileName.filename.lower():
    ...
    elif '400_households' in fileName.filename.lower() or '400_householding.csv' in fileName.filename.lower():
        reader = csv.reader(codecs.iterdecode(request.files['file'], 'utf-8'))
        next(reader)
    ...
    elif '400_transactions' in fileName.filename.lower():
